...
const MedicinePage = () => {
  ...
  return (
    <PageLayout title={t('MEDICINE_PAGE_TITLE')} emoji="💊" gradient="green" ref={visibilityRef} dataFreshness={dataFreshness} onBlackScreenOpenChange={onBlackScreenOpenChange}>
