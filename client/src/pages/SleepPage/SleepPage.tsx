...
const SleepPage = () => {
  ...
  return (
    <PageLayout title={t('SLEEP_PAGE_TITLE')} emoji="😴" gradient="indigo" ref={visibilityRef} dataFreshness={dataFreshness} onBlackScreenOpenChange={onBlackScreenOpenChange}>
